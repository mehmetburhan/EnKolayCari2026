...
{
    public partial class AccountTransactionConfiguration : IEntityTypeConfiguration<AccountTransaction>
    {
        public void Configure(EntityTypeBuilder<AccountTransaction> entity)
        {
            entity.ToTable("AccountTransaction", "finance");

            // ✅ Primary Key: Id
            entity.HasKey(e => new { e.Id }).HasName("AccountTransaction_pk");
            ...
            entity.Property(e => e.RelatedAccountTransactionId)
                .IsRequired(false)
                .HasColumnName("RelatedAccountTransactionId");

            entity.Property(e => e.CheckNoteDefId)
                .IsRequired(false)
                .HasColumnName("CheckNoteDefId");
            ...
            entity.HasOne(d => d.Company)
                  ...
                  .HasConstraintName("FK_AccountTransaction_CompanyId");

            entity.HasOne(d => d.Account)
                  .WithMany(p => p.AccountTransaction)
                  .HasForeignKey(d => d.AccountId)
                  .HasConstraintName("FK_AccountTransaction_AccountId");

            entity.HasOne(d => d.TradeDocument)
                  .WithMany(p => p.AccountTransaction)
                  .HasForeignKey(d => d.TradeDocumentId)
                  .HasConstraintName("FK_AccountTransaction_TradeDocumentId");

            entity.HasOne(d => d.CashRegister)
                  .WithMany(p => p.AccountTransaction)
                  .HasForeignKey(d => d.CashRegisterId)
                  .HasConstraintName("FK_AccountTransaction_CashRegisterId");

            OnConfigurePartial(entity);
        }

        partial void OnConfigurePartial(EntityTypeBuilder<AccountTransaction> entity);
    }
}
