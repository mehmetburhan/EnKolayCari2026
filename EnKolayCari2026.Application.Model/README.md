# EnKolayCari2026.Application.Model
...
## Amac
Generate DTO / ViewDTO / FunctionDTO / ProcedureDTO.
...
- Namespace: `EnKolayCari2026.Application.Model.*`

## DON'T
- DTO'ya UI Display/computed alan ekleme. Generate dokunma.
