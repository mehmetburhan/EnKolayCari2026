...
namespace EnKolayCari.Application.Model.DTO.Trade
{
    public class TradeDocumentDto
    {
        ...
        public long? SecondaryStoreId { get; set; }
        ...
        public long? ShippingCompanyDefId { get; set; }
        public string BillingFullNameOrTitle { get; set; }
        ...
        public string ElectronicDocumentNo { get; set; }
        public DateTime? ElectronicDocumentSentDate { get; set; }
        public string ElectronicDocumentErrors { get; set; }
        public int? ElectronicDocumentSendStatus { get; set; }
    }
}
