...
namespace EnKolayCari2026.Domain.Model.Trade
{
    public class TradeDocumentLineTemp  //Eski tablo: FaturaHareketTemp (TICARI_SLAVE1). Yeni şema: trade.TradeDocumentLineTemp
    {
        ...
        public long? SepetId { get; set; }  //Sepet oturum ID. | Eski alan: FaturaHareketTemp.SepetId
        public long CompanyId { get; set; }  //Bagli sirket. | Eski alan: FaturaHareketTemp.SirketTanimId
        public int HareketType { get; set; }  //Belge hareket tipi. | Eski alan: FaturaHareketTemp.HareketTipi
        ...
        public string SeriNo { get; set; }  //Seri numarasi. | Eski alan: FaturaHareketTemp.SeriNo
        ...
        public decimal? UnitKatsayi { get; set; }  //Birim donusum katsayisi. | Eski alan: FaturaHareketTemp.BirimKatsayi
        ...
        public decimal? ToplamTutarVatHaric { get; set; }  //Toplam tutar (KDV haric). | Eski alan: FaturaHareketTemp.ToplamTutarKdvHaric
        public decimal ToplamTutar { get; set; }  //Toplam tutar (KDV dahil). | Eski alan: FaturaHareketTemp.ToplamTutar
        public Guid? TradeDocumentGId { get; set; }  //Bagli fatura GUID. | Eski alan: FaturaHareketTemp.FaturaGId
        public Guid? TradeDocumentHareketGId { get; set; }  //Bagli fatura satir GUID. | Eski alan: FaturaHareketTemp.FaturaHareketGId
        ...
        public bool Tukenmis { get; set; }  //Stok tukendi mi? | Eski alan: FaturaHareketTemp.Tukenmis
        public Guid? StoreTanimGId { get; set; }  //Depo GUID. | Eski alan: FaturaHareketTemp.DepoTanimGId
        ...
        public decimal? VadeFarkiPercent { get; set; }  //Vade farki yuzdesi. | Eski alan: FaturaHareketTemp.VadeFarkiYuzde
