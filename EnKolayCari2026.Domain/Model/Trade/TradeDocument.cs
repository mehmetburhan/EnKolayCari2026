...
namespace EnKolayCari2026.Domain.Model.Trade
{
    public class TradeDocument  //Eski tablo: Fatura (TICARI_SLAVE1). Yeni şema: trade.TradeDocument
    {
        ...
        public long? StoreTanim1Id { get; set; }  //Ikincil/hedef depo. | Eski alan: Fatura.DepoTanim1Id
        public long AccountId { get; set; }  //Bagli cari (FK -> CariTanim.Id). | Eski alan: Fatura.CariTanimId
        public int HareketType { get; set; }  //Tanimsiz=0, SatisFaturasi=100, SatisIrsaliye=101, AlinanSiparis=103, VerilenTeklif=104, VerilenServis=105, DepoCikis=106, AlisIadeFaturasi=107, SayimGiris=108, AlisFaturasi=200, AlisIrsaliye=201, VerilenSiparis=203, AlinanTeklif=204, DepoGiris=206, SatisIadeFaturasi=207, SayimCikis=208 | Eski alan: Fatura.HareketTipi
        ...
        public DateTime? Saat { get; set; }  //Belge saati. | Eski alan: Fatura.Saat
        ...
        public int? SiparisStatus { get; set; }  //E-ticaret siparis durumu. | Eski alan: Fatura.SiparisDurumu
        public string OrderShippingSlipNumber { get; set; }  //Kargo takip/fis numarasi. | Eski alan: Fatura.SiparisKargoFisNo
        public long? ShippingFirmaDefId { get; set; }  //Kargo firmasi ID. | Eski alan: Fatura.KargoFirmaTanimId
        public string TradeDocumentTeslimAdSoyadTitle { get; set; }  //Fatura teslim alici. | Eski alan: Fatura.FaturaTeslimAdSoyadUnvan
        public string TradeDocumentTeslimEMail { get; set; }  //Fatura teslim e-posta. | Eski alan: Fatura.FaturaTeslimEMail
        public string TradeDocumentTeslimPhone { get; set; }  //Fatura teslim telefon. | Eski alan: Fatura.FaturaTeslimTelefon
        ...
        public string TeslimatIl { get; set; }  //Teslimat ili. | Eski alan: Fatura.TeslimatIl
        ...
        public string MedicalServiceCihazSeriNo { get; set; }  //Servis: cihaz seri no. | Eski alan: Fatura.ServisCihazSeriNo
        public string MedicalServiceSellerCompany { get; set; }  //Servis: satici firma. | Eski alan: Fatura.ServisSaticiFirma
        public string MedicalServiceAksesuar { get; set; }  //Servis: aksesuarlar. | Eski alan: Fatura.ServisAksesuar
        public string ServiceDeviceDescription { get; set; }  //Servis: cihaz aciklamasi. | Eski alan: Fatura.ServisCihazAciklama
        public string MedicalServiceMusteriNotu { get; set; }  //Servis: musteri notu. | Eski alan: Fatura.ServisMusteriNotu
        public string ServicePersonalNote { get; set; }  //Servis: personel notu. | Eski alan: Fatura.ServisPersonelNotu
        public bool? MedicalServiceGarantiBilgisi { get; set; }  //Servis: garanti bilgisi. | Eski alan: Fatura.ServisGarantiBilgisi
        ...
        public string MedicalServiceTeslimAlanKisi { get; set; }  //Servisi teslim alan kisi. | Eski alan: Fatura.ServisTeslimAlanKisi
        public int? TeklifStatus { get; set; }  //-100=TeklifIptal, 100=YeniTeklif, 200=TeklifKabulEdildi, 300=SozlesmeImzalandi, 400=KabulEdilmedi | Eski alan: Fatura.TeklifDurum
        public string Label { get; set; }  //Etiket. | Eski alan: Fatura.Etiket
        public bool DocumentKapali { get; set; }  //Belge kapatildi mi (stok/cari kilit)? | Eski alan: Fatura.BelgeKapali
        public DateTime? ED_SonIslemDate { get; set; }  //e-Belge son islem tarihi. | Eski alan: Fatura.ED_SonIslemTarihi
        ...
        public decimal ToplamVatTutar { get; set; }  //Toplam KDV tutari. | Eski alan: Fatura.ToplamKdvTutar
        public decimal ToplamTutar { get; set; }  //Toplam belge tutari. | Eski alan: Fatura.ToplamTutar
        ...
        public string ElektronikBelgeNo { get; set; }  //e-Belge numarasi. | Eski alan: Fatura.ElektronikBelgeNo
        ...
        public string ElektronikBelgeHatalari { get; set; }  //e-Belge gonderim hata mesajlari. | Eski alan: Fatura.ElektronikBelgeHatalari
        public int? ElektronikBelgeGonderimStatus { get; set; }  //null=Gonderilmemis, -1=Hatali, 1=Basarili | Eski alan: Fatura.ElektronikBelgeGonderimDurumu
