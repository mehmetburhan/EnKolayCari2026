...
namespace EnKolayCari.Domain.Model.Trade
{
    public class TradeDocumentLine  //Eski tablo: FaturaHareket (TICARI_SLAVE1). Yeni şema: trade.TradeDocumentLine
    {
        ...
        public int DocumentType { get; set; }  //Tanimsiz = 0, | Eski alan: FaturaHareket.HareketTipi
        ...
        public string SerialNo { get; set; }  //Seri numarasi. | Eski alan: FaturaHareket.SeriNo
        ...
        public decimal? UnitMultiplier { get; set; }  //Birim donusum katsayisi. | Eski alan: FaturaHareket.BirimKatsayi
        ...
        public decimal VatAmount { get; set; }  //KDV tutari. | Eski alan: FaturaHareket.KdvTutari
        public decimal LineAmount { get; set; }  //Satir tutari (KDV haric). | Eski alan: FaturaHareket.SatirTutari
        public bool? ExcludeFromStockCount { get; set; }  //rsaliye faturaya dnnce irsaliye iinde kalan kalemler stok saymna dahil edilmesin diye bu yaplmtr. | Eski alan: FaturaHareket.StokSayimiDahilEtme
        ...
        public decimal? DeferralPercent { get; set; }  //Vade farki yuzdesi. | Eski alan: FaturaHareket.VadeFarkiYuzde
