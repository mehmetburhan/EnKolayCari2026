...
namespace EnKolayCari.Domain.Model.Finance
{
    public class AccountTransaction  //Eski tablo: CariHareket (TICARI_SLAVE1). Yeni şema: finance.AccountTransaction
    {
        ...
        public int TransactionType { get; set; }  //SatisFaturasi=100, AlisFaturasi=200, NakitTahsilat=1, NakitOdeme=2, AlinanCek=102, AlinanSenet=103, BankaDekontTahsilat=11, BankaDekontOdeme=21, VerilenFirmaCeki=202, VerilenMusteriCeki=203, VerilenFirmaSenet=204, VerilenMusteriSenet=205 | Eski alan: CariHareket.HareketTipi
