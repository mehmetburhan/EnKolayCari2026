#!/usr/bin/env python3
"""Generate EnKolayCari2026 unified database DDL from legacy table docs."""
...
OUTPUT_SQL = ROOT / "database" / "EnKolayCari2026_CreateDatabase.sql"
...
# Medical module not in scope for EnKolayCari2026
EXCLUDED_TABLES = {
